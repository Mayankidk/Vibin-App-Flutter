...
//
//   final SupabaseClient _supabase = Supabase.instance.client;
//   final String _bucketName = 'recordings'; // your public bucket
//
//   bool get isRecording => _isRecording;
//
...
//       if (path != null) {
//         lastPath = path;
//         await _uploadAndSave(path, instrument: instrument);
//         await _incrementUserProjectCount();
//         final instrumentName = instrument ?? "AudioTrack";
//         onStatusChanged("Recording saved: ${instrumentName} track");
//         HapticFeedback.mediumImpact();
...
//         final instrumentName = instrument ?? "AudioTrack";
//         final filePath =
//             '${dir.path}/${instrumentName}_${DateTime.now().millisecondsSinceEpoch}.wav';
//
//         await _audioRecorder.start(
//           const RecordConfig(encoder: AudioEncoder.wav),
//           path: filePath,
...
//   }
//
//   /// Increment user's project count in Firestore
//   Future<void> _incrementUserProjectCount() async {
//     final user = FirebaseAuth.instance.currentUser;
//     if (user == null) return;
//
...
//   }
//
//   /// Upload audio to Supabase public bucket and save metadata in Firestore
//   Future<void> _uploadAndSave(String filePath, {String? instrument}) async {
//     final firebaseUser = FirebaseAuth.instance.currentUser;
