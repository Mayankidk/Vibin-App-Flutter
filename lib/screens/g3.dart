...
import 'recorder.dart'; // 1. IMPORTANT: Adjust this path to your Recorder component

/// A screen that simulates a 6-string guitar fretboard where users can tap
/// or strum to play pre-recorded guitar notes.
...
class _GuitarScreenState extends State<GuitarScreen> {
  // Define the audio file names for the six strings (E, A, D, G, B, E)
  final List<String> _stringNotes = [
    "guitar_E_low.wav", // String 6 (Index 0)
    "guitar_A.wav",     // String 5 (Index 1)
    "guitar_D.wav",     // String 4 (Index 2)
    "guitar_G.wav",     // String 3 (Index 3)
    "guitar_B.wav",     // String 2 (Index 4)
    "guitar_E_high.wav",// String 1 (Index 5)
  ];
  ...
  // 2. NEW: State to hold the path of the last saved file
  ...
  // 3. NEW: Method to handle the successful save from the Recorder
  void _handleRecordingSaved(String path) {
    setState(() {
      _lastRecordingPath = path;
    });
    // For debugging:
    print("New recording saved at: $path");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // 4. NEW: The Recorder component and file status
          Padding(
            padding: const EdgeInsets.symmetric(vertical: 8.0),
            child: Column(
              children: [
                Recorder(
                  // This is the callback that gets the WAV file path
                ...
                if (_lastRecordingPath != null)
                  Padding(
                    ...
                    child: Text(
                      "Saved: ${_lastRecordingPath!.split('/').last}",
